...
import { FiMail, FiLock, FiArrowRight, FiAlertCircle, FiCheck, FiShield, FiUsers, FiBarChart2 } from 'react-icons/fi';
...
export default function SignInPage() {
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center pt-4">
                <span className="text-base-content/60 font-medium">Don&#39;t have an account? </span>
                <Link 
                  href="/sign-up" 
                  className="text-primary hover:text-primary/80 font-semibold transition-colors"
                  tabIndex={loading ? -1 : 0}
 ...
 {/* Right Side - Minimal Visual Section */}
<div className="hidden lg:flex lg:w-1/2 items-center justify-center p-8 bg-gradient-to-br from-primary/5 to-secondary/5">
  <div className="text-center space-y-8 max-w-sm">
    {/* Main Illustration */}
    <div className="relative">
      <div className="w-32 h-32 bg-primary/10 rounded-3xl mx-auto flex items-center justify-center mb-4">
        <FiBarChart2 className="text-primary text-4xl" />
      </div>
      <div className="absolute top-0 right-10 w-8 h-8 bg-secondary/20 rounded-full animate-bounce"></div>
      <div className="absolute bottom-4 left-12 w-6 h-6 bg-accent/20 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <p className="text-base-content/60 leading-relaxed">
        Access your projects, collaborate with your team, and track your progress all in one place.
      </p>
    </div>

    {/* Feature Pills */}
    <div className="flex flex-wrap justify-center gap-3">
      <div className="bg-base-100 border border-base-300 rounded-xl px-4 py-2 text-sm font-medium text-base-content">
        Secure
      </div>
      <div className="bg-base-100 border border-base-300 rounded-xl px-4 py-2 text-sm font-medium text-base-content">
        Fast
